...
def generate_cached_conversations(limit=10, path="./cached_caltech256", batch_size=4):
...
if __name__ == "__main__":
    cached_conversations = generate_cached_conversations(limit=1400, path="./cached_caltech256", batch_size=10)

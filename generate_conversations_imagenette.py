...
def generate_cached_conversations(limit=10, split="train", size="full", path="./cached_imagenette", batch_size=4):
    dataset = Imagenette(root="./data", download=True, split=split, size=size)
